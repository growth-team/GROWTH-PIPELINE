...
if (ARGV[7]==nil) then
  puts "Usage: ruby growth-fy2016_pipeline_lv2_peakTrackCalibration_ver0.rb <fits list file> <channel> <mean of peak K> <sigma of peak K> <mean of peak Tl> <sigma of peak Tl> <rebin> <output file name>"
  exit 1
end
...
hist.GetXaxis.SetRangeUser(2048, 3600)
...
gainVariationK.GetYaxis.SetRangeUser(2048, 3000)
