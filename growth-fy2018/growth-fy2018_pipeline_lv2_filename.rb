#!/usr/bin/env ruby
# growth-fy2017 pipeline level-2 Version 1
...
puts "  ##        November 30th, 2017        ##"
puts "  ## Yuuki Wada  (University of Tokyo) ##"
puts "  #######################################"
puts ""

if (ARGV[4]==nil) then
  puts "Usage: ruby growth-fy2017_pipeline_lv2_ver1.rb <data index> <ch0 true/false> <ch1> <ch2> <ch3>"
  puts ""
  exit 1
end
