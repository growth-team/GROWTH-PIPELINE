...
#binNum=40
#binNum=500
#rebinTableString=[0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.2, 1.4, 1.6, 2.0, 2.4, 2.8, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5, 12.5, 13.5, 14.5]
#rebinTable=Array.new
#rebinTableString.each_with_index do |content, index|
#  rebinTable[index]=content.to_f
#end
...
#eventSpec=Root::TH1D.create("eventSpec", "eventSpec", binNum, rebinTable)
#bgdSpec=Root::TH1D.create("bgdSpec", "bgdSpec", binNum, rebinTable)
#spectrum=Root::TH1D.create("spectrum", "spectrum", binNum, rebinTable)
...
#spectrum.Sumw2()
#spectrum.Rebin(23, "nSpec", rebinTable)
#spectrum.Rebin(23, "nSpec")
#hist.SetTitle("")
